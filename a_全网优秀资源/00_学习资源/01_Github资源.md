...
![](.01_Github资源_images/311d235d.png)

韩语的量化交易学习，从0开始

# 4. Stock_Analysis_For_Quant

- Github (2k stars): https://github.com/LastAncientOne/Stock_Analysis_For_Quant

这个全面的股票分析项目采用了多种编程语言，包括Excel、Tableau、Power BI、Matlab、Python、R和Tableau。它涵盖了多种分析方法，如数据分析、技术分析、基本面分析和定量分析。此外，它还包括识别蜡烛形态并制定多样化的交易策略。该项目涵盖股票、期权、债券、共同基金和交易所交易基金（ETF），主要聚焦于交易和投资领域的定量研究。它利用数学工具、统计模型和研究方法，深入了解金融行为。此外，它整合了跨多种语言的技术指标和交易策略，采用时间序列分析、预测和机器学习（包括深度学习方法）等技术。

# 5. 人人都是量化交易员

最大的亮点是0 金融门槛，毕竟它是我这个金融门外汉学习全过程的实践记录。此外，这本书还是 0 编程门槛，全书的实验都是通过 Vibe Coding 完成，把每一次实验都是写成任务说明书（Spec）

- 开源书 （448 stars）：https://github.com/xingwudao/xquant-beginner
- 量化网站：https://xquant.shop/courses
- 示例的 Spec 和 Notebook （229 stars）：https://github.com/xingwudao/xquant-learning
